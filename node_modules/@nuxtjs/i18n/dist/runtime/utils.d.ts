...
import type { PrefixableOptions, SwitchLocalePathIntercepter, BaseUrlResolveHandler, LocaleObject } from '#internal-i18n-types';
...
export declare function uniqueKeys(...objects: Array<Record<string, unknown>>): string[];
