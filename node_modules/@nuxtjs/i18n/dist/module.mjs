...
import { resolve, parse, join as join$1, relative, isAbsolute, dirname, basename } from 'pathe';
import defu$1, { defu } from 'defu';
import { genSafeVariableName, genArrayFromRaw, genObjectFromRaw, genObjectFromValues, genString, genDynamicImport, genImport } from 'knitwork';
