...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_00790749 === 'function') {
  ...
  if (process.client && typeof nuxt_plugin_error_225eb494 === 'function') {
    await nuxt_plugin_error_225eb494(app.context, inject)
  }
